  ...
  return (
    <div className="App-header">
        ...
        <div class="rules container">
            ...
            <h3>Qu'est ce que Chrono-Story?</h3>
            ...
            <h3 className='mt-3'>Règles du jeu</h3>
            ...
            <h3 className='mt-3'>Comment jouer?</h3>
            Le joueur doit cliquer sur les barres blanches horizontales pour faire une suggestion, si cette dernière est bonne, un bloc vert avec le libélé de la question ainsi que la révélation de la date s'affichera à l'emplacement du clic, autrement un bloc rouge viendra se situera à l'emplacement adéquat.
            Le joueur doit donc faire preuve de précision dans ses suggestions car les blocs s'accumulent et les bonnes réponses se situeront souvent entre deux blocs (ex : 1 bloc avec la date 1789 au dessus d'un bloc 1804, le joueur devra donc cliquer sur la barre comprise entre ces dernières pour situer donner une réponse comprise entre 1789 et 1804) dont les dates sont de plus en plus plus proches les unes des autres.
            <h3 className='mt-3'>Fin de partie</h3>
